                        ...
                        <div class="col-xl-24">
                            <div class="wrap-form-create">
                                <div class="form-create">
                                    ...
                                    @endif
                                    <form action="{{route('cabinet.articles.store')}}" method="post" class="needs-validation" novalidate id="form-article">
                                        @csrf
                                        <div class="row">
                                            <div class="col-xl-24">
                                            ...
                                            <div class="col-xl-24">
                                                <button id="remove-item" class="btn-add" type="submit">Добавить статью</button>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="link">
