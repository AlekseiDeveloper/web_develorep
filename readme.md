...
код: <strong>    git clone https://github.com/AlekseiDeveloper/web_develorep.git </strong> или скачать архив, после установки будет создаться папка <b>site-developer</b>.
